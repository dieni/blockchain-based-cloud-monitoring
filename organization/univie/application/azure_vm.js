...
async function createServiceTest(contract, serviceInfo) {
  try {
    await contract.submitTransaction('createServiceTest')
    console.log('SERVICE CREATED')
  } catch (error) {
    console.log(`ERROR WHILE CREATING SERVICE: ${error}`)
    console.log(error.stack)
...
async function endorsmentTest(contract) {
  try {
    await contract.evaluateTransaction('getStateByRange', startKey, endKey)
  } catch (error) {
    console.log(`ERROR WHILE Testing endorsement: ${error}`)
    console.log(error.stack)
  }
}
...
async function main() {
  ...
  try {
    ...
    // await endorsmentTest(contract)
    // await createService(contract, serviceInfo)
    // await createService(contract)
